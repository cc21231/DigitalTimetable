...
class ExportAsPDFMenu(tk.Toplevel):
	def __init__(self, root, *args, **kwargs):
		...
		labelconfig = dict(background='#303841', foreground='#D8DEE9', image=self.root.pixel, font=('Calibri', 11), compound='center')

		tk.Label(frame, text='Output File', anchor='e', width=70, **labelconfig).grid(row=0, column=0, sticky='NSWE', padx=(0, 1), pady=0)
		...
		format_options_frame = tk.Frame(self, background='#3B434C')
		format_options_frame.grid(row=1, column=1, rows=9, sticky='nswe')
		...
		self.presets_selector.grid(row=1, column=0, sticky='NSWE', padx=(1, 0), pady=1, columnspan=2)
		...
		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='Page Size', font=('Calibri', 12), image=self.root.pixel, compound='center').grid(row=0, column=0, columns=4, sticky='NSWE', padx=(0, 1), pady=0)

		self.width_entry = ttk.Entry(frame, style='stipple.TEntry', width=5)
		self.width_entry.grid(row=1, column=0, sticky='NSWE', padx=0, pady=0)
		self.width_entry.insert(0, '29.7')

		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='x', font=('Calibri', 12), image=self.root.pixel, width=10, compound='center').grid(row=1, column=1, sticky='NSWE', padx=(0, 1), pady=(1, 0))

		self.height_entry = ttk.Entry(frame, style='stipple.TEntry', width=5)
		self.height_entry.grid(row=1, column=2, sticky='NSWE', padx=0, pady=(1, 0))
		self.height_entry.insert(0, '40')

		self.page_units = CustomComboBox(frame, style='TCombobox', values=['px', 'pt', 'cm', 'mm', 'in'], width=3)
		self.page_units.grid(row=1, column=3, sticky='NSWE', padx=0, pady=(1, 0))
		self.page_units.set('cm')

		# tk.Frame(frame, background='#303841').grid(row=3, column=0, columns=2, sticky='nswe')

		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='Table Size', font=('Calibri', 12), image=self.root.pixel, compound='center').grid(row=2, column=0, columns=4, sticky='NSWE', padx=(0, 1), pady=0)

		self.table_width_entry = ttk.Entry(frame, style='stipple.TEntry', width=5)
		self.table_width_entry.grid(row=3, column=0, sticky='NSWE', padx=0, pady=0)
		self.table_width_entry.insert(0, 'Auto')

		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='x', font=('Calibri', 12), image=self.root.pixel, width=10, compound='center').grid(row=3, column=1, sticky='NSWE', padx=(0, 1), pady=(1, 0))

		self.table_height_entry = ttk.Entry(frame, style='stipple.TEntry', width=5)
		self.table_height_entry.grid(row=3, column=2, sticky='NSWE', padx=0, pady=(1, 0))
		self.table_height_entry.insert(0, 'Auto')

		self.table_units = CustomComboBox(frame, style='TCombobox', values=['px', 'pt', 'cm', 'mm', 'in', '%'], width=3)
		self.table_units.grid(row=3, column=3, sticky='NSWE', padx=0, pady=(1, 0))
		self.table_units.set('cm')

		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='Margins', font=('Calibri', 11), image=self.root.pixel, compound='center').grid(row=4, column=0, columns=4, sticky='NSWE', padx=(0, 1), pady=0)

		margin_frame = tk.Frame(self, background='#3B434C')
		margin_frame.grid(row=5, column=0, columns=3, sticky='NSWE', padx=(1, 0), pady=(0, 1))
		margin_frame.columnconfigure((1, 3), weight=1)

		tk.Label(margin_frame, background='#303841', foreground='#D8DEE9', text='↔', font=('Calibri', 11), image=self.root.pixel, width=15, compound='center').grid(row=0, column=0, sticky='NSWE', padx=(0, 1), pady=(1, 0))

		self.h_margin_entry = ttk.Entry(margin_frame, style='stipple.TEntry', width=5)
		self.h_margin_entry.grid(row=0, column=1, sticky='NSWE', padx=0, pady=0)
		self.h_margin_entry.insert(0, 'Auto')

		tk.Label(margin_frame, background='#303841', foreground='#D8DEE9', text='↕', font=('Calibri', 12), image=self.root.pixel, width=15, compound='center').grid(row=0, column=2, sticky='NSWE', padx=(0, 1), pady=(1, 0))

		self.v_margin_entry = ttk.Entry(margin_frame, style='stipple.TEntry', width=5)
		self.v_margin_entry.grid(row=0, column=3, sticky='NSWE', padx=0, pady=(1, 0))
		self.v_margin_entry.insert(0, 'Auto')

		self.margin_units = CustomComboBox(frame, style='TCombobox', values=['px', 'pt', 'cm', 'mm', 'in', '%'], width=5)
		self.margin_units.grid(row=5, column=3, sticky='NSWE', padx=0, pady=(1, 0))
		...
		frame = tk.Frame(self, background='#3B434C')
		frame.grid(row=1, column=2, columns=1, rows=8, sticky='NSWE', padx=(1, 0), pady=0)
		frame.rowconfigure(0, weight=1)
		frame.columnconfigure(4, weight=1, minsize=500)

		tk.Label(frame, background='#303841', foreground='#D8DEE9', text='Formatting', font=('Calibri', 12)).grid(row=0, column=0, columns=6, sticky='NSWE', padx=(0, 1), pady=(1, 1))

		self.vscrollbar = AutoScrollbar(frame, orient='vertical', style='Custom.Vertical.TScrollbar')
		self.vscrollbar.grid(row=1, column=5, rows=1, sticky='ns')

		self.canvas = tk.Canvas(frame, highlightthickness=0, background='#222', yscrollcommand=self.vscrollbar.set, highlightbackground='#3B434C')
		self.canvas.grid(row=1, column=0, sticky='NSWE', columns=5, padx=(0, 0), pady=0)
		...
		frame = tk.Frame(frame, background='#222')
		frame.grid(row=2, column=0, columns=6, sticky='nswe', padx=(0, 0), pady=(0, 0))
		...
		MouseoverButton(frame, text='-', command=lambda: self.remove_formatting(), background='#303841', foreground='#D8DEE9', activebackground='#303841', mouseoverbackground='#3B434C', borderwidth=0, font=('Calibri', 12), image=self.root.pixel, compound='center', highlightthickness=1, highlightbackground='#4F565E', width=18, height=18).pack(side='left', padx=(0, 1), pady=(1, 1))
		...
		MouseoverButton(frame, text='Export', command=lambda: self.convert(), background='#303841', foreground='#D8DEE9', activebackground='#303841', mouseoverbackground='#3B434C', borderwidth=0, font=('Calibri', 12), image=self.root.pixel, compound='center', highlightthickness=1, highlightbackground='#4F565E', width=50, height=20).pack(side='right', padx=(1, 1), fill='y', pady=1)#.grid(row=1, column=0, sticky='nswe', padx=(0, 1), pady=(0, 0))
		MouseoverButton(frame, text='Cancel', command=lambda: self.destroy(), background='#303841', foreground='#D8DEE9', activebackground='#303841', mouseoverbackground='#3B434C', borderwidth=0, font=('Calibri', 12), image=self.root.pixel, compound='center', highlightthickness=1, highlightbackground='#4F565E', width=50, height=20).pack(side='right', padx=(0, 1), fill='y', pady=1)#.grid(row=1, column=1, sticky='nswe', padx=(0, 1), pady=(0, 0))
